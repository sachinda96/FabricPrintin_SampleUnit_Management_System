...
public class LoginFormController implements Initializable {
        ...
        try {
            ...
            if (log != null) {
                ...
                if (UserName.equals(txtUsername.getText()) && password.equals(txtPassword.getText())) {
                    Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/fps/views/FabricCuttingUnitForm.fxml"));
    ...
    private void lblCreateNew(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/fps/views/CreateAccount.fxml"));
            Stage stage = new Stage();
            stage.setScene(new Scene(root));
            stage.show();
